  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      <nav className="grid grid-flow-col gap-4">
        ...
        <a href="#cocktail-picker" className="link link-hover">Cocktail Picker</a>
        <a href="#featured-cocktails" className="link link-hover">Featured Cocktails</a>
      </nav>
      <aside>
        <p>
          Copyright © {new Date().getFullYear()} - All right reserved<br />
          Created by&nbsp;
          <a className="link link-hover" href="https://chrisnelson.netlify.app">Chris&nbsp;Nelson</a><br />
